...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-B5P5BOOK.js").then((m) => m.LandingComponent)
  },
  {
    path: "login",
    loadComponent: () => import("./chunk-MKGC4VHF.js").then((m) => m.LoginComponent)
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-HR3TGOJE.js").then((m) => m.RegisterComponent)
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-QWGVPOJR.js").then((m) => m.DashboardComponent),
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-STELUERH.js").then((m) => m.NewDepositComponent),
    canActivate: [authGuard]
  },
  {
    path: "history/:spreadsheetId",
    loadComponent: () => import("./chunk-SHDE646I.js").then((m) => m.HistoryComponent),
    canActivate: [authGuard]
  },
  {
    path: "group/:spreadsheetId",
    loadComponent: () => import("./chunk-6FAOAAPN.js").then((m) => m.GroupComponent),
    canActivate: [authGuard]
  },
  {
    path: "join/:token",
    loadComponent: () => import("./chunk-LBCGZMCO.js").then((m) => m.JoinComponent),
    canActivate: [authGuard]
  },
  {
    path: "**",
